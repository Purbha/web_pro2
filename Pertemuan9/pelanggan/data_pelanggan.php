...
function input_pelanggan() {
	...
	$sql = "INSERT INTO pelanggan (kdpel, pel_nama, pel_jk, pel_alamat, pel_telp, pel_kawin,
		pel_create, pel_update)	VALUES ('$kdpel','$pel_nama','$pel_jk','$pel_alamat',
		'$pel_telp','$pel_kawin','$pel_create','$pel_update')";	
