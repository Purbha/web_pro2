<h2> Add Transaksi &nbsp;<?php set_idtrans(); ?></h2>
<form action="index.php?page=add_transaksi" method="post" onsubmit="return focus_qty()">
    <table>
        <tr><th colspan="4">Data Pelanggan</th></tr>
        <tr>
            <td>ID Transaksi</td>
            <td>
				<?php
            ...
            <td>Tanggal</td><td><?php echo date('d M Y'); ?></td>
        </tr>
        <tr>
