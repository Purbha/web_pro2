...
<table>
    ...
    <tr>
    	<td width="200">ID Transaksi</td><td><?php echo $idtrans; ?></td>
    </tr>
	<tr>
    	<td>Tanggal</td><td><?php echo date('d-M-Y',strtotime($trans_tgl)); ?></td>
	</tr>
    <tr>
    	<td width="200">Nama Pelanggan</td><td><?php echo $pel_nama; ?></td>
    </tr>
    <tr>
    	<td width="200">Alamat</td><td><?php echo $pel_alamat; ?></td>
    </tr>
    <tr>
    	<td width="200">Telp</td><td><?php echo $pel_telp; ?></td>
    </tr>
</table>
<table>
	<tr><th>No</th><th>Kode Barang</th><th>Nama Barang</th><th>Harga</th><th>Jumlah Beli</th><th>Total</th></tr>	
	<?php
		$no = 1; $subtotal = 0;
    ...
    <tr>
        ...
        <td align="center" id="total_bayar"><?php echo number_format($subtotal); ?></td>
    </tr>
</table>