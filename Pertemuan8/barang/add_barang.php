...
<table>
    ...
    <tr><td>Kode</td><td><input type="text" name="kdbrg" maxlength="10" size="10"></td></tr>
    <tr><td>Nama Barang</td><td><input type="text" name="brg_nama" maxlength="25" size="20"></td></tr>
    <tr><td>Stok</td><td><input type="text" name="brg_stok" maxlength="5" size="3"></td></tr>
    <tr><td>Harga</td><td><input type="text" name="brg_harga" maxlength="10" size="8"></td></tr>
    <tr>
    	<td>Kategori</td>
        <td>
